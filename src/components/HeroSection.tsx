    ...
    <section className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-bold italic text-brand-main leading-tight mb-6">
          ...
          {/* Paragraph */}
          <p className="text-white text-base sm:text-lg md:text-[16px] max-w-3xl mx-auto leading-relaxed mb-8">
